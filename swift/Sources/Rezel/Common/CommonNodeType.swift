...
public final class NodeType {
    ...
    public var isTop: Bool { (flags & NodeFlag.top.rawValue) > 0 }
    public var isSkipped: Bool { (flags & NodeFlag.skipped.rawValue) > 0 }
    public var isError: Bool { (flags & NodeFlag.error.rawValue) > 0 }
    public var isAnonymous: Bool { (flags & NodeFlag.anonymous.rawValue) > 0 }
    ...
    nonisolated(unsafe) public static let none = NodeType(name: "", props: [:], id: 0, flags: NodeFlag.anonymous.rawValue)
