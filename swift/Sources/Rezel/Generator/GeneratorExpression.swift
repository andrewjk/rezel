...
public class InlineRuleExpression: Expression {
    ...
    public init(start: Int, rule: RuleDeclaration) { self.rule = rule; super.init(start: start) }
...
public class ChoiceExpression: Expression {
    override public var prec: Int { get { 1 } set { } }
    public let exprs: [Expression]

    public init(start: Int, exprs: [Expression]) { self.exprs = exprs; super.init(start: start) }
...
public class SequenceExpression: Expression {
    override public var prec: Int { get { 2 } set { } }
    public let exprs: [Expression]
...
public class ConflictMarker: Node {
    ...
    public init(start: Int, id: Identifier, type: MarkerType) { self.id = id; self.type = type; super.init(start: start) }
...
public class RepeatExpression: Expression {
    override public var prec: Int { get { 3 } set { } }
    ...
    public override var description: String { maybeParens(expr, parent: self) + kind.rawValue }
...
public class LiteralExpression: Expression {
    ...
    public init(start: Int, value: String) { self.value = value; super.init(start: start) }
    public override var description: String { "\"\(value)\"" }
    public override func eq(_ other: Expression) -> Bool {
...
public class AnyExpression: Expression {
    public override var description: String { "_" }
    public override func eq(_: Expression) -> Bool { true }
}
...
nonisolated(unsafe) public let charClasses: [String: [(Int, Int)]] = [
...
public class CharClass: Expression {
    public let type: String
    public init(start: Int, type: String) { self.type = type; super.init(start: start) }
    public override var description: String { "@" + type }
    public override func eq(_ other: Expression) -> Bool {
