...
public class TokenPrecDeclaration: Node {
	...
	public init(start: Int, items: [Expression]) {
		self.items = items; super.init(start: start)
	}
}
...
public class TokenConflictDeclaration: Node {
	...
	public init(start: Int, a: Expression, b: Expression) {
		self.a = a; self.b = b; super.init(start: start)
	}
}
...
public class Identifier: Node {
	...
	public init(start: Int, name: String) {
		self.name = name; super.init(start: start)
	}
