...
export const Action = {
	...
	RepeatFlag: (1 << 17) satisfies number as number,
	...
	GotoFlag: (1 << 17) satisfies number as number,
	...
	// expressions).
	StayFlag: (1 << 18) satisfies number as number,
} as const;
...
export type Specialize = (typeof Specialize)[keyof typeof Specialize];
...
export type Seq = (typeof Seq)[keyof typeof Seq];
...
export type ParseState = (typeof ParseState)[keyof typeof ParseState];
